...
import {AuthContext} from 'C:\\Users\\asus.LAPTOP-F97U0B83\\Desktop\\React\\reels\\src\\Context\\AuthProvider.js'
        ...
        <div>
            <div className="container">
                <div className='phoneimg'>
                    <img className="float_img" src={images[idx % images.length]}></img>
                </div>
                <div className ='modal_container'>
                    <div className='login_section'>
                        <div className='login-area'>
                            <img className ='instaLogo' src={img}></img>
